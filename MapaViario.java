       ...
       do {
        ...
        while(!(casaAnterior.equals("O"))){
            ...
            if (movimento.toUpperCase().equals("D")){
                ...
                }else if (mapa[iCarro][jCarro+1].equals(">") || mapa[iCarro][jCarro+1].equals("H") || mapa[iCarro][jCarro+1].equals("+") || mapa[iCarro][jCarro+1].equals("X") || mapa[iCarro][jCarro+1].equals("D") || mapa[iCarro][jCarro+1].equals("E") || mapa[iCarro][jCarro+1].equals("O") || mapa[iCarro][jCarro+1].equals("i")){
